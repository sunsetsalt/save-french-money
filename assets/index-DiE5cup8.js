 ...
 */var Ao=Symbol.for("react.element"),U0=Symbol.for("react.portal"),I0=Symbol.for("react.fragment"),F0=Symbol.for("react.strict_mode"),O0=Symbol.for("react.profiler"),k0=Symbol.for("react.provider"),B0=Symbol.for("react.context"),z0=Symbol.for("react.forward_ref"),H0=Symbol.for("react.suspense"),V0=Symbol.for("react.memo"),G0=Symbol.for("react.lazy"),Ud=Symbol.iterator;function W0(t){return t===null||typeof t!="object"?null:(t=Ud&&t[Ud]||t["@@iterator"],typeof t=="function"?t:null)}var Hp={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},Vp=Object.assign,Gp={};function Ts(t,e,n){this.props=t,this.context=e,this.refs=Gp,this.updater=n||Hp}Ts.prototype.isReactComponent={};Ts.prototype.setState=function(t,e){if(typeof t!="object"&&typeof t!="function"&&t!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,t,e,"setState")};Ts.prototype.forceUpdate=function(t){this.updater.enqueueForceUpdate(this,t,"forceUpdate")};function Wp(){}Wp.prototype=Ts.prototype;function Sf(t,e,n){this.props=t,this.context=e,this.refs=Gp,this.updater=n||Hp}var Mf=Sf.prototype=new Wp;Mf.constructor=Sf;Vp(Mf,Ts.prototype);Mf.isPureReactComponent=!0;var Id=Array.isArray,Xp=Object.prototype.hasOwnProperty,Ef={current:null},jp={key:!0,ref:!0,__self:!0,__source:!0};function Yp(t,e,n){var i,r={},s=null,o=null;if(e!=null)for(i in e.ref!==void 0&&(o=e.ref),e.key!==void 0&&(s=""+e.key),e)Xp.call(e,i)&&!jp.hasOwnProperty(i)&&(r[i]=e[i]);var a=arguments.length-2;if(a===1)r.children=n;else if(1<a){for(var l=Array(a),u=0;u<a;u++)l[u]=arguments[u+2];r.children=l}if(t&&t.defaultProps)for(i in a=t.defaultProps,a)r[i]===void 0&&(r[i]=a[i]);return{$$typeof:Ao,type:t,key:s,ref:o,props:r,_owner:Ef.current}}function X0(t,e){return{$$typeof:Ao,type:t.type,key:e,ref:t.ref,props:t.props,_owner:t._owner}}function Tf(t){return typeof t=="object"&&t!==null&&t.$$typeof===Ao}function j0(t){var e={"=":"=0",":":"=2"};return"$"+t.replace(/[=:]/g,function(n){return e[n]})}var Fd=/\/+/g;function Ol(t,e){return typeof t=="object"&&t!==null&&t.key!=null?j0(""+t.key):e.toString(36)}function wa(t,e,n,i,r){var s=typeof t;(s==="undefined"||s==="boolean")&&(t=null);var o=!1;if(t===null)o=!0;else switch(s){case"string":case"number":o=!0;break;case"object":switch(t.$$typeof){case Ao:case U0:o=!0}}if(o)return o=t,r=r(o),t=i===""?"."+Ol(o,0):i,Id(r)?(n="",t!=null&&(n=t.replace(Fd,"$&/")+"/"),wa(r,e,n,"",function(u){return u})):r!=null&&(Tf(r)&&(r=X0(r,n+(!r.key||o&&o.key===r.key?"":(""+r.key).replace(Fd,"$&/")+"/")+t)),e.push(r)),1;if(o=0,i=i===""?".":i+":",Id(t))for(var a=0;a<t.length;a++){s=t[a];var l=i+Ol(s,a);o+=wa(s,e,n,l,r)}else if(l=W0(t),typeof l=="function")for(t=l.call(t),a=0;!(s=t.next()).done;)s=s.value,l=i+Ol(s,a++),o+=wa(s,e,n,l,r);else if(s==="object")throw e=String(t),Error("Objects are not valid as a React child (found: "+(e==="[object Object]"?"object with keys {"+Object.keys(t).join(", ")+"}":e)+"). If you meant to render a collection of children, use an array instead.");return o}function Bo(t,e,n){if(t==null)return t;var i=[],r=0;return wa(t,i,"","",function(s){return e.call(n,s,r++)}),i}function Y0(t){if(t._status===-1){var e=t._result;e=e(),e.then(function(n){(t._status===0||t._status===-1)&&(t._status=1,t._result=n)},function(n){(t._status===0||t._status===-1)&&(t._status=2,t._result=n)}),t._status===-1&&(t._status=0,t._result=e)}if(t._status===1)return t._result.default;throw t._result}var Yt={current:null},Aa={transition:null},q0={ReactCurrentDispatcher:Yt,ReactCurrentBatchConfig:Aa,ReactCurrentOwner:Ef};function qp(){throw Error("act(...) is not supported in production builds of React.")}Be.Children={map:Bo,forEach:function(t,e,n){Bo(t,function(){e.apply(this,arguments)},n)},count:function(t){var e=0;return Bo(t,function(){e++}),e},toArray:function(t){return Bo(t,function(e){return e})||[]},only:function(t){if(!Tf(t))throw Error("React.Children.only expected to receive a single React element child.");return t}};Be.Component=Ts;Be.Fragment=I0;Be.Profiler=O0;Be.PureComponent=Sf;Be.StrictMode=F0;Be.Suspense=H0;Be.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=q0;Be.act=qp;Be.cloneElement=function(t,e,n){if(t==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+t+".");var i=Vp({},t.props),r=t.key,s=t.ref,o=t._owner;if(e!=null){if(e.ref!==void 0&&(s=e.ref,o=Ef.current),e.key!==void 0&&(r=""+e.key),t.type&&t.type.defaultProps)var a=t.type.defaultProps;for(l in e)Xp.call(e,l)&&!jp.hasOwnProperty(l)&&(i[l]=e[l]===void 0&&a!==void 0?a[l]:e[l])}var l=arguments.length-2;if(l===1)i.children=n;else if(1<l){a=Array(l);for(var u=0;u<l;u++)a[u]=arguments[u+2];i.children=a}return{$$typeof:Ao,type:t.type,key:r,ref:s,props:i,_owner:o}};Be.createContext=function(t){return t={$$typeof:B0,_currentValue:t,_currentValue2:t,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},t.Provider={$$typeof:k0,_context:t},t.Consumer=t};Be.createElement=Yp;Be.createFactory=function(t){var e=Yp.bind(null,t);return e.type=t,e};Be.createRef=function(){return{current:null}};Be.forwardRef=function(t){return{$$typeof:z0,render:t}};Be.isValidElement=Tf;Be.lazy=function(t){return{$$typeof:G0,_payload:{_status:-1,_result:t},_init:Y0}};Be.memo=function(t,e){return{$$typeof:V0,type:t,compare:e===void 0?null:e}};Be.startTransition=function(t){var e=Aa.transition;Aa.transition={};try{t()}finally{Aa.transition=e}};Be.unstable_act=qp;Be.useCallback=function(t,e){return Yt.current.useCallback(t,e)};Be.useContext=function(t){return Yt.current.useContext(t)};Be.useDebugValue=function(){};Be.useDeferredValue=function(t){return Yt.current.useDeferredValue(t)};Be.useEffect=function(t,e){return Yt.current.useEffect(t,e)};Be.useId=function(){return Yt.current.useId()};Be.useImperativeHandle=function(t,e,n){return Yt.current.useImperativeHandle(t,e,n)};Be.useInsertionEffect=function(t,e){return Yt.current.useInsertionEffect(t,e)};Be.useLayoutEffect=function(t,e){return Yt.current.useLayoutEffect(t,e)};Be.useMemo=function(t,e){return Yt.current.useMemo(t,e)};Be.useReducer=function(t,e,n){return Yt.current.useReducer(t,e,n)};Be.useRef=function(t){return Yt.current.useRef(t)};Be.useState=function(t){return Yt.current.useState(t)};Be.useSyncExternalStore=function(t,e,n){return Yt.current.useSyncExternalStore(t,e,n)};Be.useTransition=function(){return Yt.current.useTransition()};Be.version="18.3.1";zp.exports=Be;var Mt=zp.exports;/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var $0=Mt,K0=Symbol.for("react.element"),Z0=Symbol.for("react.fragment"),Q0=Object.prototype.hasOwnProperty,J0=$0.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,e_={key:!0,ref:!0,__self:!0,__source:!0};function $p(t,e,n){var i,r={},s=null,o=null;n!==void 0&&(s=""+n),e.key!==void 0&&(s=""+e.key),e.ref!==void 0&&(o=e.ref);for(i in e)Q0.call(e,i)&&!e_.hasOwnProperty(i)&&(r[i]=e[i]);if(t&&t.defaultProps)for(i in e=t.defaultProps,e)r[i]===void 0&&(r[i]=e[i]);return{$$typeof:K0,type:t,key:s,ref:o,props:r,_owner:J0.current}}gl.Fragment=Z0;gl.jsx=$p;gl.jsxs=$p;Bp.exports=gl;var j=Bp.exports,Kp={exports:{}},pn={},Zp={exports:{}},Qp={};/**
 * @license React
...
`)+`
`+c);const v=g+m+o,y=g+c+a,C=Rp(r,r.VERTEX_SHADER,v),R=Rp(r,r.FRAGMENT_SHADER,y);r.attachShader(S,C),r.attachShader(S,R),n.index0AttributeName!==void 0?r.bindAttribLocation(S,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(S,0,"position"),r.linkProgram(S);function w(L){if(t.debug.checkShaderErrors){const G=r.getProgramInfoLog(S).trim(),z=r.getShaderInfoLog(C).trim(),$=r.getShaderInfoLog(R).trim();let Q=!0,Y=!0;if(r.getProgramParameter(S,r.LINK_STATUS)===!1)if(Q=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,S,C,R);else{const J=bp(r,C,"vertex"),N=bp(r,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(S,r.VALIDATE_STATUS)+`
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Op=wd("Info",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M12 16v-4",key:"1dtifu"}],["path",{d:"M12 8h.01",key:"e9boi3"}]]),Ad=()=>{const[t,e]=Mt.useState(!1);return Mt.useEffect(()=>{const n=()=>{e(window.innerWidth<1200)};return n(),window.addEventListener("resize",n),()=>{window.removeEventListener("resize",n)}},[]),t},Gs=[{id:1,text:"Multiple income streams are essential",points:4},{id:2,text:"Regular asset investment builds wealth",points:3},{id:3,text:"Emergency funds provide financial security",points:10},{id:4,text:"Cryptocurrency knowledge is valuable",points:5},{id:5,text:"Real estate creates long-term value",points:4.5},{id:6,text:"Portfolio diversification reduces risk",points:3},{id:7,text:"Financial optimization requires regular review",points:2},{id:8,text:"Passive income enables financial freedom",points:5},{id:9,text:"Tax strategies maximize wealth retention",points:2},{id:10,text:"Clear planning accelerates wealth building",points:3},{id:11,text:"Financial education drives better decisions",points:2},{id:12,text:"Business ownership creates equity value",points:4}],MT=t=>t===0?"🕸️":t<=7?"🧱":t<=14?"💼":t<=21?"💰":t<=28?"💎":t<=35?"🔱":t<=42?"🧠":t<=43.8?"👑":"🌌",ET=t=>t===0?"Getting Started":t<=7?"Building Foundation":t<=14?"Taking Shape":t<=21?"Gaining Momentum":t<=28?"Well Positioned":t<=35?"Highly Aligned":t<=42?"Elite Status":t<=43.8?"Wealth Master":"Transcendent",kp=t=>({1:"https://en.wikipedia.org/wiki/Multiple_income_streams",2:"https://en.wikipedia.org/wiki/Investment",3:"https://en.wikipedia.org/wiki/Emergency_fund",4:"https://en.wikipedia.org/wiki/Cryptocurrency",5:"https://en.wikipedia.org/wiki/Real_estate_investment",6:"https://en.wikipedia.org/wiki/Diversification_(finance)",7:"https://en.wikipedia.org/wiki/Financial_planning",8:"https://en.wikipedia.org/wiki/Passive_income",9:"https://en.wikipedia.org/wiki/Tax_strategy",10:"https://en.wikipedia.org/wiki/Wealth_management",11:"https://en.wikipedia.org/wiki/Financial_literacy",12:"https://en.wikipedia.org/wiki/Business_ownership"})[t]||"https://en.wikipedia.org/wiki/Personal_finance",TT=()=>{const[t,e]=Mt.useState(new Set),n=Ad(),i=u=>{const f=new Set(t);f.has(u)?f.delete(u):f.add(u),e(f)},r=()=>{const u=window.scrollY,f=window.innerHeight,d=document.body.scrollHeight-f,h=d/8,p=Math.floor(u/h),_=Math.min((p+1)*h,d);window.scrollTo({top:_,behavior:"smooth"})},s=Array.from(t).reduce((u,f)=>{const d=Gs.find(h=>h.id===f);return u+((d==null?void 0:d.points)||0)},0),o=Math.min(s/43.8*100,100),a=MT(s),l=ET(s);return j.jsxs("div",{className:"fixed inset-0 z-10 pointer-events-none",children:[n?j.jsxs("div",{className:"flex flex-col h-full p-4 gap-4 pointer-events-auto overflow-y-auto",children:[j.jsx("div",{className:"flex-shrink-0",children:j.jsxs("div",{className:"backdrop-blur-md bg-black/40 rounded-2xl p-6 border border-yellow-400/30 shadow-2xl",children:[j.jsxs("div",{className:"text-center mb-6",children:[j.jsx("h1",{className:"text-2xl font-bold text-yellow-100 mb-2",children:"Wealth Alignment"}),j.jsx("p",{className:"text-base text-yellow-100/80",children:"Financial principles assessment"})]}),j.jsxs("div",{className:"text-center",children:[j.jsx("div",{className:"text-5xl mb-4 transition-all duration-500 transform hover:scale-110",children:a}),j.jsx("div",{className:"text-lg font-semibold text-yellow-100 mb-2",children:l}),j.jsxs("div",{className:"text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-amber-400 mb-4",children:[s," ",s>43.8&&j.jsx("span",{className:"text-sm text-yellow-300",children:"/ 43.8+"})]}),j.jsxs("div",{className:"relative w-full",children:[j.jsx("div",{className:"h-3 bg-black/40 rounded-full border border-yellow-400/20 overflow-hidden",children:j.jsx("div",{className:"h-full bg-gradient-to-r from-yellow-500 to-amber-600 transition-all duration-700 ease-out relative",style:{width:`${o}%`},children:s>43.8&&j.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-amber-400 to-yellow-300 animate-pulse"})})}),j.jsxs("div",{className:"flex justify-between text-xs text-yellow-300/60 mt-2",children:[j.jsx("span",{children:"0"}),j.jsx("span",{children:"22"}),j.jsxs("span",{children:["43.8",s>43.8&&"+"]})]})]})]})]})}),j.jsx("div",{className:"flex-1 min-h-0",children:j.jsxs("div",{className:"grid grid-cols-2 gap-4 h-full",children:[j.jsx("div",{className:"backdrop-blur-md bg-black/40 rounded-2xl p-4 border border-yellow-400/20 shadow-2xl",children:j.jsx("div",{className:"h-full overflow-y-auto scrollbar-thin scrollbar-track-black/20 scrollbar-thumb-yellow-400/30 pr-1",children:j.jsx("div",{className:"space-y-3",children:Gs.slice(0,6).map(u=>{const f=t.has(u.id);return j.jsxs("button",{onClick:()=>i(u.id),className:`
                          ...
                          `,children:[j.jsxs("p",{className:`text-sm font-medium transition-colors duration-300 leading-relaxed ${f?"text-yellow-100":"text-yellow-100/80"}`,children:[u.text," ",j.jsxs("span",{className:`font-bold ${f?"text-yellow-300":"text-yellow-400/70"}`,children:["+",u.points]})]}),f&&j.jsx("div",{className:"absolute inset-0 rounded-xl bg-gradient-to-r from-yellow-400/10 to-amber-400/10 animate-pulse pointer-events-none"})]},u.id)})})})}),j.jsx("div",{className:"backdrop-blur-md bg-black/40 rounded-2xl p-4 border border-yellow-400/20 shadow-2xl",children:j.jsx("div",{className:"h-full overflow-y-auto scrollbar-thin scrollbar-track-black/20 scrollbar-thumb-yellow-400/30 pr-1",children:j.jsx("div",{className:"space-y-3",children:Gs.slice(6,12).map(u=>{const f=t.has(u.id);return j.jsxs("button",{onClick:()=>i(u.id),className:`
                            group relative p-3 rounded-xl border transition-all duration-300 text-left w-full
                            transform hover:scale-[1.02] hover:shadow-lg
                            ${f?"bg-gradient-to-r from-yellow-500/20 to-amber-600/20 border-yellow-400/50 shadow-yellow-400/20 shadow-lg":"bg-black/20 border-yellow-400/20 hover:border-yellow-400/40 hover:bg-black/30"}
                          `,children:[j.jsxs("p",{className:`text-sm font-medium transition-colors duration-300 leading-relaxed ${f?"text-yellow-100":"text-yellow-100/80"}`,children:[u.text," ",j.jsxs("span",{className:`font-bold ${f?"text-yellow-300":"text-yellow-400/70"}`,children:["+",u.points]})]}),f&&j.jsx("div",{className:"absolute inset-0 rounded-xl bg-gradient-to-r from-yellow-400/10 to-amber-400/10 animate-pulse pointer-events-none"})]},u.id)})})})})]})})]}):j.jsx(j.Fragment,{children:j.jsx("div",{className:"absolute inset-0 flex items-center justify-center px-4",children:j.jsxs("div",{className:"backdrop-blur-md bg-black/30 rounded-3xl p-8 border border-yellow-400/30 shadow-2xl pointer-events-auto max-w-md w-full mx-4",children:[j.jsxs("div",{className:"text-center mb-6",children:[j.jsx("div",{className:"flex justify-center mb-3",children:j.jsx("div",{className:"p-2 rounded-full bg-yellow-500/20 backdrop-blur-sm border border-yellow-400/30",children:j.jsx(ST,{className:"w-6 h-6 text-yellow-300"})})}),j.jsx("h1",{className:"text-2xl font-bold text-yellow-100 mb-1",children:"Wealth Alignment"}),j.jsx("p",{className:"text-sm text-yellow-100/80",children:"Financial principles assessment"})]}),j.jsxs("div",{className:"text-center mb-6",children:[j.jsx("div",{className:"text-6xl mb-3 transition-all duration-500 transform hover:scale-110",children:a}),j.jsx("div",{className:"text-lg font-semibold text-yellow-100 mb-1",children:l}),j.jsxs("div",{className:"text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-amber-400 mb-4",children:[s," ",s>43.8&&j.jsx("span",{className:"text-xs text-yellow-300",children:"/ 43.8+"})]}),j.jsxs("div",{className:"relative w-full",children:[j.jsx("div",{className:"h-3 bg-black/40 rounded-full border border-yellow-400/20 overflow-hidden",children:j.jsx("div",{className:"h-full bg-gradient-to-r from-yellow-500 to-amber-600 transition-all duration-700 ease-out relative",style:{width:`${o}%`},children:s>43.8&&j.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-amber-400 to-yellow-300 animate-pulse"})})}),j.jsxs("div",{className:"flex justify-between text-xs text-yellow-300/60 mt-2",children:[j.jsx("span",{children:"0"}),j.jsx("span",{children:"22"}),j.jsxs("span",{children:["43.8",s>43.8&&"+"]})]})]})]})]})})}),j.jsx("div",{className:"hidden xl:block absolute bottom-8 left-1/2 -translate-x-1/2 pointer-events-auto z-20",children:j.jsx("button",{onClick:r,className:"bg-black/80 rounded-lg px-3 py-2 border border-white/20 animate-pulse hover:bg-black/90 hover:border-yellow-400/40 transition-all duration-300 cursor-pointer",children:j.jsxs("div",{className:"flex items-center gap-2",children:[j.jsx("span",{className:"text-xs font-medium text-white",children:"Scroll"}),j.jsx(yT,{className:"w-3 h-3 text-white/80"})]})})}),j.jsx("div",{className:"absolute bottom-4 left-4 pointer-events-auto z-20",children:j.jsx("a",{href:"https://en.wikipedia.org",target:"_blank",rel:"noopener noreferrer",className:"text-xs text-white/60 hover:text-yellow-300 transition-colors duration-300 backdrop-blur-sm bg-black/20 px-2 py-1 rounded border border-white/10 hover:border-yellow-400/30",children:"made by xxx"})}),j.jsx("div",{className:"absolute left-4 top-1/2 -translate-y-1/2 w-80 max-w-[calc(50vw-200px)] hidden xl:block pointer-events-auto",children:j.jsx("div",{className:"backdrop-blur-md bg-black/40 rounded-2xl p-4 border border-yellow-400/20 shadow-2xl",children:j.jsx("div",{className:"h-96 overflow-y-auto scrollbar-thin scrollbar-track-black/20 scrollbar-thumb-yellow-400/30 pr-2",children:j.jsx("div",{className:"space-y-3",children:Gs.slice(0,6).map(u=>{const f=t.has(u.id);return j.jsxs("button",{onClick:()=>i(u.id),className:`
                      group relative p-3 rounded-xl border transition-all duration-300 text-left w-full
                      transform hover:scale-[1.02] hover:shadow-lg
                      ${f?"bg-gradient-to-r from-yellow-500/20 to-amber-600/20 border-yellow-400/50 shadow-yellow-400/20 shadow-lg":"bg-black/20 border-yellow-400/20 hover:border-yellow-400/40 hover:bg-black/30"}
                    `,children:[j.jsxs("div",{className:"flex items-start justify-between",children:[j.jsx("div",{className:"flex-1 pr-2",children:j.jsxs("p",{className:`text-sm font-medium transition-colors duration-300 inline ${f?"text-yellow-100":"text-yellow-100/80"}`,children:[u.text,j.jsx("a",{href:kp(u.id),target:"_blank",rel:"noopener noreferrer",className:"inline-block ml-1 text-yellow-300/60 hover:text-yellow-300 transition-colors duration-200",onClick:d=>d.stopPropagation(),children:j.jsx(Op,{className:"w-3 h-3"})})]})}),j.jsxs("div",{className:"flex items-center gap-2",children:[j.jsxs("span",{className:`text-xs font-bold px-2 py-1 rounded-full transition-all duration-300 ${f?"bg-yellow-400 text-black":"bg-yellow-400/20 text-yellow-300"}`,children:["+",u.points]}),j.jsx("div",{className:`
                        ...
                        `,children:f&&j.jsx("div",{className:"w-1.5 h-1.5 bg-black rounded-full animate-pulse"})})]})]}),f&&j.jsx("div",{className:"absolute inset-0 rounded-xl bg-gradient-to-r from-yellow-400/10 to-amber-400/10 animate-pulse pointer-events-none"})]},u.id)})})})})}),j.jsx("div",{className:"absolute right-4 top-1/2 -translate-y-1/2 w-80 max-w-[calc(50vw-200px)] hidden xl:block pointer-events-auto",children:j.jsx("div",{className:"backdrop-blur-md bg-black/40 rounded-2xl p-4 border border-yellow-400/20 shadow-2xl",children:j.jsx("div",{className:"h-96 overflow-y-auto scrollbar-thin scrollbar-track-black/20 scrollbar-thumb-yellow-400/30 pr-2",children:j.jsx("div",{className:"space-y-3",children:Gs.slice(6,12).map(u=>{const f=t.has(u.id);return j.jsxs("button",{onClick:()=>i(u.id),className:`
                      group relative p-3 rounded-xl border transition-all duration-300 text-left w-full
                      transform hover:scale-[1.02] hover:shadow-lg
                      ${f?"bg-gradient-to-r from-yellow-500/20 to-amber-600/20 border-yellow-400/50 shadow-yellow-400/20 shadow-lg":"bg-black/20 border-yellow-400/20 hover:border-yellow-400/40 hover:bg-black/30"}
                    `,children:[j.jsxs("div",{className:"flex items-start justify-between",children:[j.jsx("div",{className:"flex-1 pr-2",children:j.jsxs("p",{className:`text-sm font-medium transition-colors duration-300 inline ${f?"text-yellow-100":"text-yellow-100/80"}`,children:[u.text,j.jsx("a",{href:kp(u.id),target:"_blank",rel:"noopener noreferrer",className:"inline-block ml-1 text-yellow-300/60 hover:text-yellow-300 transition-colors duration-200",onClick:d=>d.stopPropagation(),children:j.jsx(Op,{className:"w-3 h-3"})})]})}),j.jsxs("div",{className:"flex items-center gap-2",children:[j.jsxs("span",{className:`text-xs font-bold px-2 py-1 rounded-full transition-all duration-300 ${f?"bg-yellow-400 text-black":"bg-yellow-400/20 text-yellow-300"}`,children:["+",u.points]}),j.jsx("div",{className:`
                          w-4 h-4 rounded-full border-2 transition-all duration-300 flex items-center justify-center
                          ${f?"border-yellow-400 bg-yellow-400":"border-yellow-400/40 bg-transparent group-hover:border-yellow-400/60"}
                        `,children:f&&j.jsx("div",{className:"w-1.5 h-1.5 bg-black rounded-full animate-pulse"})})]})]}),f&&j.jsx("div",{className:"absolute inset-0 rounded-xl bg-gradient-to-r from-yellow-400/10 to-amber-400/10 animate-pulse pointer-events-none"})]},u.id)})})})})})]})},Ta=["https://images.pexels.com/photos/730547/pexels-photo-730547.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop","https://images.pexels.com/photos/259027/pexels-photo-259027.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop","https://images.pexels.com/photos/164527/pexels-photo-164527.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop","https://images.pexels.com/photos/210600/pexels-photo-210600.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop","https://images.pexels.com/photos/534216/pexels-photo-534216.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop","https://images.pexels.com/photos/2068975/pexels-photo-2068975.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop","https://images.pexels.com/photos/1602726/pexels-photo-1602726.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop","https://images.pexels.com/photos/3943716/pexels-photo-3943716.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop"],wT=()=>{const t=Ad();Mt.useRef(null);const[e,n]=Mt.useState(!1),[i,r]=Mt.useState(0),[s,o]=Mt.useState(!1);return Mt.useEffect(()=>{(async()=>{const l=Ta.map(u=>new Promise((f,d)=>{const h=new Image;h.onload=f,h.onerror=d,h.src=u}));try{await Promise.all(l),n(!0)}catch(u){console.warn("Some images failed to preload:",u),n(!0)}})()},[]),Mt.useEffect(()=>{if(!e)return;const a=()=>{const f=window.scrollY,d=window.innerHeight,h=document.body.scrollHeight-d,p=f/h,_=Math.floor(p*Ta.length)%Ta.length;_!==i&&!s&&(o(!0),r(_),setTimeout(()=>{o(!1)},500))};let l=!1;const u=()=>{l||(requestAnimationFrame(()=>{a(),l=!1}),l=!0)};return window.addEventListener("scroll",u),a(),()=>{window.removeEventListener("scroll",u)}},[e,i,s]),t?null:j.jsxs(j.Fragment,{children:[!e&&j.jsx("div",{className:"fixed inset-0 -z-20 bg-gradient-to-br from-yellow-900 to-amber-900 flex items-center justify-center",children:j.jsxs("div",{className:"text-yellow-100 text-center",children:[j.jsx("div",{className:"w-8 h-8 border-2 border-yellow-400 border-t-transparent rounded-full animate-spin mx-auto mb-4"}),j.jsx("p",{className:"text-sm",children:"Loading experience..."})]})}),e&&j.jsx("div",{className:"fixed inset-0 -z-20",children:Ta.map((a,l)=>j.jsx("div",{className:`absolute inset-0 bg-cover bg-center bg-no-repeat transition-opacity duration-500 ease-in-out ${l===i?"opacity-100":"opacity-0"}`,style:{backgroundImage:`url(${a})`}},l))})]})};function AT(){const t=Ad();return j.jsx("div",{className:"relative w-full",children:j.jsxs("div",{style:{height:"600vh"},className:"relative",children:[j.jsx(wT,{}),!t&&j.jsx(_T,{}),t&&j.jsx("div",{className:"fixed inset-0 -z-10 bg-gradient-to-br from-yellow-900 to-amber-900"}),j.jsx(TT,{})]})})}Zg(document.getElementById("root")).render(j.jsx(Mt.StrictMode,{children:j.jsx(AT,{})}));
